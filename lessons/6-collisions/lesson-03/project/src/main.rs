...
impl World {
    ...
    // TODO: implement resolve_collisions using the two-pass pattern:
    //
    // fn resolve_collisions(&mut self) {
    //     // Pass 1: detect (shared borrows — read only)
    ...
    //         }
    //     }
    //     // Pass 2: apply positional correction (sequential mutable access)
