...
// TODO: define struct Paddle { rect: Rect }
//
// impl Paddle {
//     fn new(x: f32) -> Self { ... }
...
// TODO: define struct Ball { rect: Rect }
//
// impl Ball {
//     fn new() -> Self { ... }
//       - rect centred on screen: Rect::new(
...
async fn main() {
    // TODO: create left and right Paddle, and a Ball
    ...
    loop {
        ...
        // TODO: call left.draw(), right.draw(), ball.draw()
