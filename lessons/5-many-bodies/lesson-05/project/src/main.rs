...
async fn main() {
    ...
    loop {
        ...
        // TODO: if the left mouse button is pressed, spawn a new Body at the mouse position
        // is_mouse_button_pressed(MouseButton::Left)  — true for one frame when clicked
        // mouse_position()                            — returns (f32, f32)
