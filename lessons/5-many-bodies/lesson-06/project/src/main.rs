...
// --- Body ---
// TODO: add a `color: Color` field to Body
struct Body {
    position: Vec2,
    velocity: Vec2,
    radius: f32,
...
impl Body {
    // TODO: add `color: Color` parameter and store it
    ...
    // TODO: update draw to use self.color instead of WHITE
    fn draw(&self) {
        draw_circle(self.position.x, self.position.y, self.radius, WHITE);
    }
}

// TODO: add a random_color() function using macroquad::rand::gen_range
...
async fn main() {
    ...
    loop {
        ...
        if is_mouse_button_pressed(MouseButton::Left) {
            ...
            // TODO: pass a random_color() instead of WHITE once you've added the color field
        ...
        // TODO: draw the body count using draw_text and format!
