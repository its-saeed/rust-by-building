...
impl World {
    ...
    // TODO: add fn step(&mut self, dt: f32)
    //       iterate with self.bodies.iter_mut()
    //       call body.update(dt) on each body
...
async fn main() {
    ...
    world.add_body(Body::new(Vec2::new(200.0, 150.0), Vec2::new(120.0,  80.0), 20.0));
    world.add_body(Body::new(Vec2::new(500.0, 100.0), Vec2::new(-90.0, 110.0), 15.0));
    world.add_body(Body::new(Vec2::new(350.0, 300.0), Vec2::new( 60.0, -70.0), 25.0));

    loop {
        let dt = get_frame_time();
        clear_background(BLACK);

        // TODO: call world.step(dt)
        world.draw_all();
